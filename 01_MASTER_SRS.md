...
**Status:** Claude gap review reconciled. Final owner baseline approval pending resolution/deferral of remaining material open questions.
...
TruckMate SHOULD calculate deadhead from an appropriate starting/current location to the first pickup and loaded miles across the applicable pickup/delivery stops. Total trip miles SHOULD combine applicable deadhead and loaded miles.
